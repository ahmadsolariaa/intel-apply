...
export declare const ChatConversation: (({ children, className, initial, onScroll, ref, resize, ...props }: import("./chat-conversation").ChatConversationRootProps) => import("react/jsx-runtime").JSX.Element) & {
...
export type { ChatConversationContentProps, ChatConversationProps, ChatConversationRootProps, ChatConversationScrollAnchorProps, ChatConversationScrollButtonProps, } from "./chat-conversation";
