...
export declare const ChatListView: (<T extends object>({ children, className, density, ...props }: import("./chat-list-view").ChatListViewRootProps<T>) => import("react/jsx-runtime").JSX.Element) & {
...
export type { ChatListViewIconProps, ChatListViewItemContentProps, ChatListViewItemProps, ChatListViewMetaProps, ChatListViewPreviewProps, ChatListViewProps, ChatListViewRootProps, ChatListViewTextProps, ChatListViewTitleProps, } from "./chat-list-view";
