...
export declare const ChatMessageActions: (({ children, className, ...props }: import("./chat-message-actions").ChatMessageActionsRootProps) => import("react/jsx-runtime").JSX.Element) & {
...
export type { ChatMessageActionIconProps, ChatMessageActionPresetProps, ChatMessageActionsCopiedIconProps, ChatMessageActionsCopyProps, ChatMessageActionsMenuProps, ChatMessageActionsRegenerateProps, ChatMessageActionsRootProps, ChatMessageActionsRootProps as ChatMessageActionsProps, ChatMessageActionsThumbsDownProps, ChatMessageActionsThumbsUpProps, } from "./chat-message-actions";
