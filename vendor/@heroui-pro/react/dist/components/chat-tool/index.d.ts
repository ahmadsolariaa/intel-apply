...
export declare const ChatTool: (({ active, approveLabel, argsText, children, className, errorText, input, isExpandable, onApprove, onReject, output, rejectLabel, state, toolCallId, toolName, triggerPrefix, ...props }: import("./chat-tool").ChatToolRootProps) => import("react/jsx-runtime").JSX.Element) & {
...
export declare const ChatToolGroup: (({ active, children, className, ...props }: import("./chat-tool-group").ChatToolGroupRootProps) => import("react/jsx-runtime").JSX.Element) & {
...
export { ChatToolApproval, ChatToolApprovalActions, ChatToolApprove, ChatToolArgs, ChatToolContent, ChatToolError, ChatToolGroupContent, ChatToolGroupRoot, ChatToolGroupTrigger, ChatToolMeta, ChatToolReject, ChatToolResult, ChatToolRoot, ChatToolStatusIcon, ChatToolTrigger, };
export type { ChatToolActionPresetProps, ChatToolApprovalActionsProps, ChatToolApprovalProps, ChatToolArgsProps, ChatToolContentProps, ChatToolErrorProps, ChatToolMetaProps, ChatToolProps, ChatToolResultProps, ChatToolRootProps, ChatToolStatusIconProps, ChatToolTriggerProps, } from "./chat-tool";
export type { ChatToolGroupContentProps, ChatToolGroupProps, ChatToolGroupRootProps, ChatToolGroupTriggerProps, } from "./chat-tool-group";
